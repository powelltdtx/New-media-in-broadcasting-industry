	...
	<div class="container-fluid">
		...
		<div class="row clearfix">
			...
			<div class="col-md-10 text-center header_nav clearfix">
				<div class="col-md-3">
					<a href="templet_search.do">模板管理</a>
				</div>
				<div class="col-md-3">
					<a href="mangeFile.html">文件管理</a>
				</div>
				<div class="col-md-3" id="jkPer"
					style="border-bottom: 2px solid #FF7A19 !important;">
					<a href="heartBeat_search.do" style="color: #FF7A19 !important;">预警监控</a>
				</div>
				<div class="col-md-3">
					<a href="sysMange.html">系统管理</a>
				</div>
			</div>
		</div>
		</header>
		...
		<div class="con">
			<a class="con_sub headerCur" href="javascript:void(0);"><i></i>服务器监控</a>
		</div>
		<div class="con">
			<a class="con_sub CMSManage" href="javascript:void(0);"><i></i>文件监控</a>
		</div>
		</content> </nav> <!--右侧数据(默认)-->
