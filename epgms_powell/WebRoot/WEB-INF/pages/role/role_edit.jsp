...
<div class="main-wrap">
	<div class="form-head">
		<div class="crumb"><a href="role_searchAllRoles.do">角色管理</a> &gt; <a href="javascript:void(0)">编辑页</a></div>
	</div>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="form-con" style="width:0">
        <tr>
            ...
            <td width="650"><input type="text" name="vo.name" class="ipt bt" id="roleName" value="<s:property value="vo.name"/>" onkeyup="WidthCheck(this,20)"/>
            <!-- 隐藏字段 -->
            <input type="hidden" name="vo.id" class="ipt bt" id="roleId" value="<s:property value="vo.id"/>"/>
            </td>
        </tr>
        <tr>
            <th>备注：</th>
            <td colspan="3"><textarea  id="" cols="30" rows="3" class="txtarea w635" name="vo.remark" onkeyup="WidthCheck(this,200)"><s:property value='vo.remark'/></textarea></td>
        </tr>
         <tr>
        	<th><i>*</i>权限范围</th>
            <td style="padding-top:10px;">
            <s:iterator var="menuVo" value="#request.allMenuList">
				<div class="cbox">	
					<div class="cT"><input type="checkbox" class="allC" /><label><s:property value="#menuVo.name"/></label></div>
					<ul class="cArry">
					    <s:iterator var="btn" value="#menuVo.buttonList">
					     <li><input type="checkbox" name="vo.btnCodes" value="<s:property value="#btn.code"/>"   
