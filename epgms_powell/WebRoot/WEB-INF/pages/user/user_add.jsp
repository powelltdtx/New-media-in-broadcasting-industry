...
<div class="main-wrap">
	<div class="form-head">
		<div class="crumb"><a href="user_search.do">用户管理</a> &gt; <a href="javascript:void(0)">添加页</a></div>
	</div>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="form-con">
        ...
        <tr>
            ...
            <td width="270">
            <s:textfield cssClass="ipt bt" name="userinfoVO.userid" id="userid" onkeyup="WidthCheck(this,20)"/>
            </td>
        ...
        <tr>
            ...
            <td width="270">
            <input type="password" class="ipt bt" id="password" name="userinfoVO.password" onkeyup="WidthCheck(this,20)"/>
            </td>
            <th width="140"><i>*</i>重复密码：</th>
             <td width="270"><input type="password" class="ipt bt" id="password2" onkeyup="WidthCheck(this,20)"/></td>
        </tr>
	    <tr>
	        <th width="140"></th>
        ...
        <tr>
         ...
         <tr>
            ...
            <th width="140">角色：</th>
			<td width="">
             	<select  class="text-input" name="userinfoVO.userrole">
