...
<body>
<form action="templet_edit.do" method="post" id = "form1">
<div class="main-wrap">
	<div class="form-head">
		<div class="crumb"><a href="templet_search.do">模板管理</a> > <a href="#">编辑模板</a></div>
	</div>
	<div class="form-main" style="padding-top: 10px;">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="form-con add_table">
			<tbody>
				<tr>
					<th width="140"><i>*</i>模板编码：</th>
					<input type="hidden" name="templetVO.id" value = "<s:property value="templetVO.id"/>"/>
