...
<link rel="stylesheet" href="resource/newpages/css/SerMont.css" />
</head>
<body>
	<div class="box">
		<div class="left">
			...
			<div class="Analysis">
				...
				<div class="line">
					<img src="resource/newpages/img/line.jpg" />
				</div>
		...
		<div class="middle">
			...
			<div class="map" id="map">
				<img src="resource/newpages/img/map.png" />
			</div>
		...
		<div class="right">
			...
			<div class="list">
				<div class="serverListone">
					...
					<div class="one" id="one">
						<img src="resource/newpages/img/ling.png" class="lent" id="pic1" />
					</div>
				</div>
				<div class="serverListone">
					<div class="serName">
					...
					<img src="resource/newpages/img/ling.png" class="lent" id="pic2" />
				</div>
				<div class="serverListone">
					<div class="serName">
						<span>服务器</span> <span>3</span>
					</div>
					<img src="resource/newpages/img/ling.png" class="lent" id="pic3" />
				</div>
				<div class="serverListone">
					<div class="serName">
						<span>服务器</span> <span>4</span>
					</div>
					<img src="resource/newpages/img/ling.png" class="lent" id="pic4" />
				</div>
			</div>
			<div class="Servermiddle">
				<div class="serverListTwo">
					...
					<img src="resource/newpages/img/ling.png" class="lent" id="pic5" />
				</div>
				<div class="serverListTwo">
					<div class="serName">
						<span>服务器</span> <span>6</span>
					</div>
					<img src="resource/newpages/img/ling.png" class="lent" id="pic6" />
				</div>
				<div class="serverListTwo">
					<div class="serName">
						<span>服务器</span> <span>7</span>
					</div>
					<img src="resource/newpages/img/ling.png" class="lent" id="pic7" />
				</div>
			</div>
			<div class="ServerBottom">
				<div class="serverListThree">
					...
					<div class="eight">
						<img src="resource/newpages/img/ling.png" class="lent" id="pic8" />
					</div>
				</div>
				<div class="serverListThree">
					<div class="serName">
					...
					<img src="resource/newpages/img/ling.png" class="lent" id="pic9" />
				</div>
				<div class="serverListThree">
					<div class="serName">
						<span>服务器</span> <span>10</span>
					</div>
					<img src="resource/newpages/img/ling.png" class="lent" id="pic10" />
				</div>
				<div class="serverListThree">
					<div class="serName">
						<span>服务器</span> <span>11</span>
					</div>
					<img src="resource/newpages/img/ling.png" class="lent" id="pic11" />
				</div>
			</div>
			<div class="serverLast">
				<div class="serverListfour">
					...
					<img src="resource/newpages/img/ling.png" class="lent" id="pic12" />
				</div>
				<div class="serverListfour">
					<div class="serName">
						<span>服务器</span> <span>13</span>
					</div>
					<img src="resource/newpages/img/ling.png" class="lent" id="pic13" />
				</div>
				<div class="serverListfour">
					<div class="serName">
						<span>服务器</span> <span>14</span>
					</div>
					<img src="resource/newpages/img/ling.png" class="lent" id="pic14" />
				</div>
			</div>
			<div class="rightFoot">
				<div class="footTop">
...
<script src="resource/newpages/js/SerMont.js"></script>
<script src="resource/newpages/js/echarts.min.js"></script>
