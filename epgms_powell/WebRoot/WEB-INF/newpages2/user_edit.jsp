							...
							<tbody>
								<tr>
									...
									<td width="270"><s:textfield cssClass="ipt"
											...
											onkeyup="WidthCheck(this,20)" /> <input type="hidden"
										id="olduserid" name="userinfoVO.olduserid"
										value="<s:property value="userinfoVO.userid"/>"
								...
								<tr>
									...
									<td width="270"><input type="password" class="ipt bt"
										id="password"
										value="<s:property value="userinfoVO.password"/>"
										name="userinfoVO.password" onkeyup="WidthCheck(this,20)" /></td>
								...
								<tr>
									...
									<td width=""><select class="ipt choseSele"
										name="userinfoVO.userrole" id="role">
