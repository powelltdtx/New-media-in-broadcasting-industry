							...
							<tbody>
									...
									<td width=""><select name="vo.groupid" id="servegroupid"
										class="ipt choseSele">
											...
											<s:iterator value="#request.grouplist" var="groupvo">
												<option value="<s:property value="#groupvo.id"/>"><s:property
								...
								<tr>
									...
									<td colspan="3"><textarea name="vo.description" rows=""
											cols="" id="remark" class="remark"></textarea></td>
								</tr>
							</tbody>
						</table>
						<div class="buttons">
							<input type="button" class="btn blue-btn" id="confirm" value="添加" />
		...
		$('#confirm')
				.on(
						...
						function() {
							...
							document.forms[0].action = "serversManage_save.do";
