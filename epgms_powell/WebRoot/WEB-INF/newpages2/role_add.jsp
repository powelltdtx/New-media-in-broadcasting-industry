		...
		<div class="container-fluid">
			...
			<main>
				...
				<div class="main-wrap">
					<div class="form-head">
						<div class="crumb">
							<a href="roleManger.html">角色管理</a> &gt;
							<a href="javascript:void(0)">角色新增</a>
						</div>
					</div>
					<div class="form-main" style="padding-top: 10px;">
						<form action="" method="post">
							<table cellpadding="0" cellspacing="0" border="0" class="form-con" style="width:55%">
								<tr>
									<th width="10%"><i>*</i>角色名称</th>
									<td width="50%"><input type="text" name="vo.name" class="ipt bt" id="roleName" onkeyup="WidthCheck(this,20)" /></td>
								</tr>
								...
								<tr>
									<th>备注：</th>
									 <td colspan="3"><textarea id="" cols="30" rows="3" class="txtarea w635 remark" name="vo.remark" onkeyup="WidthCheck(this,200)"></textarea></td>
								</tr>

							</table>
						</form>
						<div class="buttons">
							<input type="button" class="btn blue-btn" value="保存" onclick="toSave()" id="sver"/>
