...
/*    $(".header_nav a").click(function() {
    ...
    function addTitle() {
        ...
        for(var i=0;i<len2;i++){
            var tb_text = $('tbody tr').find('td:nth-child(2)').eq(i).find('span').html();
            $('tbody tr').find('td:nth-child(2)').eq(i).find('span').attr('title',tb_text);
        }
        var len3 = $('tbody tr').find('td:nth-child(3)').length;
        for(var i=0;i<len3;i++){
            var tb_text = $('tbody tr').find('td:nth-child(3)').eq(i).find('span').html();
            $('tbody tr').find('td:nth-child(3)').eq(i).find('span').attr('title',tb_text);
        }
    }
    //header导航栏
    function getNode(){
...
//              $(this).css("border-bottom","4px solid rgba(240,10,23,0)")
//          })
        }
    }
    // 左侧导航点击跳转及样式
  /*  $('.con_sub').click(function () {
    ...
    $('#SYManage').click(function () {
    	 window.location.href = 'cpsp.html';
    });
    $('.CMSManage').click(function () {
        window.location.href = 'fileMan.html';
    });
    $('#templeCple').click(function () {
        window.location.href = "templet.html";
    });
    $('#newTemp').click(function () {
        window.location.href = 'newTemp.html';
    });
    $('#temVie').click(function () {
        window.location.href = 'tempView.html';
    });
    $('#main').click(function () {
        window.location.href = 'main.html';
    });
     $('#creTemp').click(function () {
        window.location.href = 'createTemple.html';
    });*/
