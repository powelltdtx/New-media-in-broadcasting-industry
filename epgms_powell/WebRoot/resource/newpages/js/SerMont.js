...
function serState(servers, states) {
			...
			for (var y = 0; y < state.length; y++) {
				if (state[y] == 5) {
					for (var z = 0; z < lent.length; z++) {
						console.log(lent[z]);
						lent[z].src = "resource/newpages/img/ling.png";
					}
	...
	for (var i = 0; i < server.length; i++) {
		...
		if (server[i] == "服务器1") {
			...
			for (var y = 0; y < state.length; y++) {
				if (state[y] == 1) {
					pic.src = "resource/newpages/img/ling.png";
				}
				if (state[y] == 2) {
					pic.src = "resource/newpages/img/red.png";
				}
				if (state[y] == 3) {
					pic.src = "resource/newpages/img/green.png";
				}
			}
		}
		if (server[i] == "服务器2") {
